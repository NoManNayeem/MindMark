...
ALLOWED_HOSTS = ["*"]  # Allow all for dev, restrict in prod
...
ROOT_URLCONF = 'mindmark_backend.urls'
...
WSGI_APPLICATION = 'mindmark_backend.wsgi.application'
...
DATABASES = {
    ...
    "memory": {
        "ENGINE": "django.db.backends.sqlite3",
        "NAME": BASE_DIR / "memory.sqlite3",
    }
}

# Use a router to separate agent memory DB
DATABASE_ROUTERS = ["agent.db_routers.MemoryRouter"]
